...
' <rdf:Description rdf:about="' . RDF_ABOUT_PREFIX . $uuid . '">' . 
               // '<rdf:Description>' . 
...
'</rdf:RDF>';
        ...
        $client -> setUri(BASE_URI .  "/api/concept?");
